...
The components are mounted on an aluminum plate held in place by 3D printed hold downs, M3 hardware, 3M self-adhesive tie-down pads contained in a Zulkit aluminum cabinet. All internal connections consists of high-quality SMA connectors, coax and USB cables. 12VDC is provided to the PSWS components and the active antenna by 1.2 amp linear power supplies. While the chart above indicates an Astron RS-12A, individual good quality power from less expensive power supplies are quite acceptable. Be sure not use inexpensive switching supplies like type are included with most consumer electronics. Consider snap-on chokes on all DC lines choked to reduce or eliminate any potention RF.
...
![image](./assets/images/K3DFD-component-layout.png)
...
![image](./assets/images/K3DFD-baseplate.png)
...
![image](./assets/images/K3DFD-hardware.png)
