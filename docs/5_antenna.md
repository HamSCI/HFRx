...
While it allows for one cable to be used for both the RF and the DC, as HamSCI wants to study the received transmissions, we want to minimize the signal's noise as much as possible. To do so, we will use a separate cable to supply the antenna with power.   

<img width="540" height="960" alt="image" src="https://github.com/user-attachments/assets/0d3e73a9-dcb8-4f74-bd75-c6ccab19c0ee" />   

To make this DC/RF separation, a  simple internal adjustment to the amplifier is made by moving a jumper J-3 per page 7 of the RSEAV-1 [manual](https://static.dxengineering.com/global/images/instructions/dxe-rseav-1fvi.pdf?_gl=1*gvjbi2*_gcl_aw*R0NMLjE3ODEyNzM4NDkuRUFJYUlRb2JDaE1JMGVibS1PNkJsUU1WNDBUX0FSM0ZCemZBRUFBWUFTQUFFZ0tyOF9EX0J3RQ..*_gcl_au*MzIxODM4MDkuMTc3OTgyNDIzMS4xMDIyNjczNzQyLjE3ODEyNzM4ODcuMTc4MTI3Mzg4Nw..*_ga*MTU2MjkyMTYwNy4xNzc5ODI0MjMx*_ga_NZB590FMHY*czE3ODI0OTA0MzkkbzQkZzAkdDE3ODI0OTA0NDkkajUwJGwwJGgw).   

<img width="1707" height="750" alt="image" src="https://github.com/user-attachments/assets/cb283d4b-d0cf-437b-a40e-7a77cff32dce" />   
